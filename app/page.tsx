...
export default async function Home() {
  ...
  return <section className="max-w-7xl mx-auto my-14">
    ...
    <h2 className="mt-24 font-bold text-slate-400 text-3xl">For Sanity</h2>
    ...
    <article className="mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {projects.map((project) => (
        ...
        >
          ...
          <div className="mt-2 font-extrabold bg-gradient-to-r from-orange-400 via-red-500 to-purple-600 bg-clip-text text-transparent text-center whitespace-nowrap text-ellipsis">
            {project.name}
          </div>
        </Link>
      ))}
